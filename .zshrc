...
# Wallpaper-derived prompt accent (generated by wallust-apply.sh). Sourced after
# p10k so it overrides the directory/prompt-char accent colors.
...
_wallust_refresh_accent() {
  [[ -f $_wallust_accent_src ]] || return
  local m; m=$(stat -c %.Y "$_wallust_accent_src" 2>/dev/null) || return
...
# alias poetry_venv="poetry env info --path"

# bun completions
[ -s "/home/plo/.bun/_bun" ] && source "/home/plo/.bun/_bun"
...
# pnpm
export PNPM_HOME="/home/plo/.local/share/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
